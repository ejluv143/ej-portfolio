        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-[clamp(20px,3vw,50px)]">
          {projects.map((project, index) => (
            <div key={index} className="group">
              ...
              <div className="lg:hidden overflow-hidden rounded-3xl border border-black/10 dark:border-white/10 bg-white/90 dark:bg-white/5 shadow-[0_0_30px_rgba(59,130,246,0.2)] transition-transform duration-300 hover:-translate-y-1">
